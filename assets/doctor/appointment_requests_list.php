...
$appointment_qry = "SELECT appointment_id, patient_id, appointment_reason, appointment_comms, appointment_date, appointment_status FROM appointment_table WHERE appointment_status != 'Completed' AND doctor_id IS NULL";
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="#" method="post">
                                                            <input type="date" class="col-12 col-lg-4 btn btn-sm bg-secondary text-white" name="appointment_date" value="" required />
                                                            <button class="col-12 col-lg-4 btn btn-sm bg-success text-white" type="submit" name="accept_appointment" value="<?= $result['appointment_id']; ?>">Accept</button>
                                                        </form>
                                                    </td>
                                                </tr>
                                        <?php
